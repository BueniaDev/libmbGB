...
namespace gb
{
	...
	switch (opcode)
	{
	    ...
	    case 0x01: bc.reg = (getimmword()); cycles = 12; break;
	    case 0x02: load8intomem(bc.reg, af.hi); cycles = 8; break;
	    case 0x03: bc.reg = (increg(bc.reg)); cycles = 8; break;
	    ...
	    case 0x09: hl.reg = (add16reg(hl.reg, bc.reg)); cycles = 8; break;
	    case 0x0A: af.hi = (store8frommem(bc.reg)); cycles = 8; break;
	    case 0x0B: bc.reg = (decreg(bc.reg)); cycles = 8; break;
	    ...
	    break;
	    case 0x11: de.reg = (getimmword()); cycles = 12; break;
	    case 0x12: load8intomem(de.reg, af.hi); cycles = 8; break;
	    case 0x13: de.reg = (increg(de.reg)); cycles = 8; break;
	    ...
	    case 0x19: hl.reg = (add16reg(hl.reg, de.reg)); cycles = 8; break;
	    case 0x1A: af.hi = (store8frommem(de.reg)); cycles = 8; break;
	    case 0x1B: de.reg = (decreg(de.reg)); cycles = 8; break;
	    ...
	    case 0x36: load8intomem(hl.reg, getimmbyte()); cycles = 12; break;
	    ...
	    case 0x46: bc.hi = (store8frommem(hl.reg)); cycles = 8; break;
	    ...
	    case 0x4E: bc.lo = (store8frommem(hl.reg)); cycles = 8; break;
	    ...
	    case 0x56: de.hi = (store8frommem(hl.reg)); cycles = 8; break;
	    ...
	    case 0x5E: de.lo = (store8frommem(hl.reg)); cycles = 8; break;
	    ...
	    case 0x66: hl.hi = (store8frommem(hl.reg)); cycles = 8; break;
	    ...
	    case 0x6E: hl.lo = (store8frommem(hl.reg)); cycles = 8; break;
	    case 0x6F: hl.lo = (af.hi); cycles = 4; break;
	    case 0x70: load8intomem(hl.reg, bc.hi); cycles = 8; break;
	    case 0x71: load8intomem(hl.reg, bc.lo); cycles = 8; break;
	    case 0x72: load8intomem(hl.reg, de.hi); cycles = 8; break;
	    case 0x73: load8intomem(hl.reg, de.lo); cycles = 8; break;
	    case 0x74: load8intomem(hl.reg, hl.hi); cycles = 8; break;
	    case 0x75: load8intomem(hl.reg, hl.lo); cycles = 8; break;
	    case 0x76: halt(); cycles = 4; break;
	    case 0x77: load8intomem(hl.reg, af.hi); cycles = 8; break;
	    ...
	    case 0x7E: af.hi = (store8frommem(hl.reg)); cycles = 8; break;
	    ...
	    case 0x86: af.hi = (addreg(store8frommem(hl.reg))); cycles = 8; break;
	    ...
	    case 0x8E: af.hi = (adcreg(store8frommem(hl.reg))); cycles = 8; break;
	    ...
	    case 0x96: af.hi = (subreg(store8frommem(hl.reg))); cycles = 8; break;
	    ...
	    case 0x9E: af.hi = (sbcreg(store8frommem(hl.reg))); cycles = 8; break;
	    ...
	    case 0xA6: andreg(store8frommem(hl.reg)); cycles = 8; break;
	    ...
	    case 0xAE: xorreg(store8frommem(hl.reg)); cycles = 8; break;
	    ...
	    case 0xB6: orreg(store8frommem(hl.reg)); cycles = 8; break;
	    ...
	    case 0xBE: cmpreg(store8frommem(hl.reg)); cycles = 8; break;
	    case 0xBF: cmpreg(af.hi); cycles = 4; break;
	    case 0xC0: cycles = retcond(!iszero()); break;
	    case 0xC1: bc.reg = (pop()); cycles = 12; break;
	    ...
	    case 0xC5: push(bc.reg); cycles = 16; break;
	    ...
	    case 0xE1: hl.reg = (pop()); cycles = 12; break;
	...
	switch (opcode)
	{
	    ...
	    case 0x06: load8intomem(hl.reg, rlc(store8frommem(hl.reg))); cycles = 16; break;
	    ...
	    case 0x0E: load8intomem(hl.reg, rrc(store8frommem(hl.reg))); cycles = 16; break;
	    ...
	    case 0x16: load8intomem(hl.reg, rl(store8frommem(hl.reg))); cycles = 16; break;
	    ...
	    case 0x1E: load8intomem(hl.reg, rr(store8frommem(hl.reg))); cycles = 16; break;
	    ...
	    case 0x26: load8intomem(hl.reg, sla(store8frommem(hl.reg))); cycles = 16; break;
	    ...
	    case 0x2E: load8intomem(hl.reg, sra(store8frommem(hl.reg))); cycles = 16; break;
	    ...
	    case 0x36: load8intomem(hl.reg, swap(store8frommem(hl.reg))); cycles = 16; break;
	    ...
	    case 0x3E: load8intomem(hl.reg, srl(store8frommem(hl.reg))); cycles = 16; break;
	    ...
	    case 0x46: bit(store8frommem(hl.reg), 0); cycles = 12; break;
	    ...
	    case 0x4E: bit(store8frommem(hl.reg), 1); cycles = 12; break;
	    ...
	    case 0x56: bit(store8frommem(hl.reg), 2); cycles = 12; break;
	    ...
	    case 0x5E: bit(store8frommem(hl.reg), 3); cycles = 12; break;
	    ...
	    case 0x66: bit(store8frommem(hl.reg), 4); cycles = 12; break;
	    ...
	    case 0x6E: bit(store8frommem(hl.reg), 5); cycles = 12; break;
	    ...
	    case 0x76: bit(store8frommem(hl.reg), 6); cycles = 12; break;
	    ...
	    case 0x7E: bit(store8frommem(hl.reg), 7); cycles = 12; break;
	    ...
	    case 0x86: load8intomem(hl.reg, res(store8frommem(hl.reg), 0)); cycles = 16; break;
	    ...
	    case 0x8E: load8intomem(hl.reg, res(store8frommem(hl.reg), 1)); cycles = 16; break;
	    ...
	    case 0x96: load8intomem(hl.reg, res(store8frommem(hl.reg), 2)); cycles = 16; break;
	    ...
	    case 0x9E: load8intomem(hl.reg, res(store8frommem(hl.reg), 3)); cycles = 16; break;
	    ...
	    case 0xA6: load8intomem(hl.reg, res(store8frommem(hl.reg), 4)); cycles = 16; break;
	    ...
	    case 0xAE: load8intomem(hl.reg, res(store8frommem(hl.reg), 5)); cycles = 16; break;
	    ...
	    case 0xB6: load8intomem(hl.reg, res(store8frommem(hl.reg), 6)); cycles = 16; break;
	    ...
	    case 0xBE: load8intomem(hl.reg, res(store8frommem(hl.reg), 7)); cycles = 16; break;
	    ...
	    case 0xC6: load8intomem(hl.reg, set(store8frommem(hl.reg), 0)); cycles = 16; break;
	    ...
	    case 0xCE: load8intomem(hl.reg, set(store8frommem(hl.reg), 1)); cycles = 16; break;
	    ...
	    case 0xD6: load8intomem(hl.reg, set(store8frommem(hl.reg), 2)); cycles = 16; break;
	    ...
	    case 0xDE: load8intomem(hl.reg, set(store8frommem(hl.reg), 3)); cycles = 16; break;
	    ...
	    case 0xE6: load8intomem(hl.reg, set(store8frommem(hl.reg), 4)); cycles = 16; break;
	    ...
	    case 0xEE: load8intomem(hl.reg, set(store8frommem(hl.reg), 5)); cycles = 16; break;
	    ...
	    case 0xF6: load8intomem(hl.reg, set(store8frommem(hl.reg), 6)); cycles = 16; break;
	    ...
	    case 0xFE: load8intomem(hl.reg, set(store8frommem(hl.reg), 7)); cycles = 16; break;
